...
- Mensajes a mostrar: console.log()
- Variables: const
- Condición: if y else

## Dificultades encontradas

En este ejercicio no he encontrado ninguna dificultad en cuanto a operaciones, simplemente me ha costado un poco desarrollar las explicaciones del mismo ejercicio, pero me han ayudado a su misma vez a refrescar viejos conceptos de javascript.

## Conclusión

Este ejercicio me ha ayudado a refrescar de nuevo parte del temario de javascript del año pasado, además de que al explicarlo me ha ayudado a asentar mejor los conceptos utlizados en el ejercicio.
